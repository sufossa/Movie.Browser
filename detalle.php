<?php
    ...
    //Extrae el valor de cada categoria
    if ($peliculaDetalles) {
    ...
    <div class="container">
        <?php if ($peliculaDetalles): ?>
            <div class="pelicula-detalles">
                <p align="right" onclick="location.href='catalogo1.php'"><button>X</button></p>
            ...
            <div class="recomendaciones">
                ...
                ?>
                    <div class="recomendacion">
                        <a href='detalle.php?titulo=<?php echo urlencode($recomendacion); ?>'>
